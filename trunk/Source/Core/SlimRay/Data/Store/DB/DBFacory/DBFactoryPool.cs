...
namespace SlimRay.Data.DB.DBFacory
{
    public class DBFacoryPool
    {
        ...
        private bool _IsConnInfoExists(IConnectionInfo ci)
        {
            ...
            {
                if (SlimRay.Utils.Strings.CharCompare(connInfo.ConnectionString, ci.ConnectionString))
                {
                    return true;
                }
            }
        ...
        private int _GetConnectionInfoIndex(IConnectionInfo ci)
        {
            ...
            {
                if (SlimRay.Utils.Strings.CharCompare(ci.ConnectionString, _ConnectionInfoItems[i].ConnectionString))
                {
                    return i;
                }
            }
